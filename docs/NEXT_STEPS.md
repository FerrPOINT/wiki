...
1. Move the current `WikiBackendPort` PostgreSQL implementation into app/infra repository interfaces/implementations for identity, spaces and documents using `domain::wiki`.
