...
- Add repository/API tests beyond the current persistence, permission, audit, archived-document, revision/search, task/phase boundary and file-evidence smoke for spaces and PostgreSQL-backed permission edge-case combinations.
...
1. Continue focused repository/API hardening for spaces and PostgreSQL-backed permission edge cases.
