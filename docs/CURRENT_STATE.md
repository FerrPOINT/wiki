...
| CLI shape                  | Current | `wiki` CLI command surface drafted for public API operations; mocked HTTP smoke tests cover filtered search including `document_type`, document create, template apply by `document_type`, URL/file evidence creation with document/task/phase owners and evidence list owner filters                                                           |
...
| Screenshot evidence        | Current | 17 desktop and 5 mobile screenshots regenerated for the MVP page set; `/evidence` screenshot shows document owner field and document/task/phase filters                                                                                                                                                                                 |
