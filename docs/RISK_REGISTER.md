...
|---|---|---|---|---|
| R-001 | Inherited task-tracker code leaks into Wiki behavior | High | High | Replace domain modules before feature implementation |
...
| R-007 | Integration secrets leaked in logs | High | Low | redaction middleware and log tests |
...
|---|---|---|
| R-001 | Backend owner | Domain/API migration removes inherited routes |
