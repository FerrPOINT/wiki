...
Каталоги задач и фаз можно фильтровать по ключу или названию и просматривать постранично. В досье ссылки на документы и материалы открывают выбранную запись; счётчики показывают количество связанных объектов, а не оценку готовности процесса.
