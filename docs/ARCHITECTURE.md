...
| Разбиение transition SQLx adapter на app/repositories               | В работе: identity/auth/users/settings, spaces/space_members/tree и document/revision operation modules отделены; следующий шаг - task/phase/evidence/template/audit/search use cases и dedicated repositories                                                                                                                                                                                                                                                              |
