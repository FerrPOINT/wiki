...
| Разбиение transition SQLx adapter на app/repositories               | В работе: identity/auth/users/settings, spaces/space_members/tree, document/revision, task/phase dossier и evidence/attachment operation modules отделены; следующий шаг - template/audit/search modules, затем полноценные app use cases и dedicated repositories                                                                                                                                                                                                                                                   |
