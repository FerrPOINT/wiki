...
| Разбиение transition SQLx adapter на app/repositories               | В работе: transition adapter разложен на focused modules; search вынесен первым вертикальным срезом в app-level `WikiSearchUseCase` + `WikiSearchRepository`; следующий шаг - такие же use cases и dedicated repositories для identity, spaces, documents, dossiers, evidence, templates и audit                                                                                                                                                                                                                                                                                                        |
