...
| Разбиение transition SQLx adapter на app/repositories               | В работе: identity/auth/users/settings и spaces/space_members/tree operation modules отделены; следующий шаг - documents/task/phase/evidence/search use cases и dedicated repositories                                                                                                                                                                                                                                                                   |
