...
| Разбиение transition SQLx adapter на app/repositories               | В работе: transition adapter разложен на focused modules; следующий шаг - полноценные app use cases и dedicated repositories вместо прямых SQLx operation modules                                                                                                                                                                                                                                                                                                                                                                             |
