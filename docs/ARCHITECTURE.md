...
| Разбиение transition SQLx adapter на app/repositories               | В работе: identity/auth/users/settings operation module отделён; следующий шаг - spaces/documents/evidence/search use cases и dedicated repositories                                                                                                                                                                                                                                                                         |
