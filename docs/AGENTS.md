...
- Новую Wiki persistence-логику писать на SQLx по ADR-0001. Унаследованный SeaORM/task-tracker код можно трогать только для удаления, карантина или временной совместимости, не расширяя task-tracker модель. Default backend-сборка не должна зависеть от унаследованных task-tracker app/infra services.
