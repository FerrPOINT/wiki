...
| REQ-AUTH-002 | Roles | `/users`, `/spaces/{space_key}/members` | `users`, `space_members`, `audit_log` | `/users`, `/admin`, `wiki space members` | RBAC policy tests |
...
| REQ-SPC-002 | Space management | `/spaces`, `/spaces/{space_key}`, `/spaces/{space_key}/archive` | `spaces`, `audit_log` | `/spaces`, `/settings`, `/admin` | admin API tests |
| REQ-SPC-003 | Space members | `/spaces/{space_key}/members` | `space_members`, `audit_log` | `/users`, `wiki space members` | RBAC integration tests |
...
| REQ-DOC-005 | Revision history | `/documents/{document_id}/revisions` | `document_revisions` | revision panel, `wiki doc history` | revision API tests |
...
| REQ-AUD-001 | Audit | `/audit-log` | `audit_log` | `/audit-log`, `/admin` | audit write tests |
