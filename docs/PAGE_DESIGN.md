...
| `/spaces` | Spaces and document tree entry | loading, empty spaces, tree error, permission error | open tree/document, create space when allowed | `04-spaces.png`, `m-spaces.png` |
