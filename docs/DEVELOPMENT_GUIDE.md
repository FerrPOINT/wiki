...
4. Regenerate OpenAPI after API DTO/route changes; run `pnpm generate:api` to refresh frontend DTO types; replace handwritten endpoint wrappers with a full generated operation client after the backend Wiki API is stable.
