...
echo "Resetting admin password for ${WIKI_BOOTSTRAP__ADMIN_EMAIL} through backend bootstrap..."
docker compose up -d --force-recreate backend

echo "Admin password bootstrap applied. Login after backend healthcheck is green."
